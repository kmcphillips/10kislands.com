...
Card.create!(
  ...
  background: File.open(Rails.root.join("db", "seeds", "images", "home-pic1.png"))
)

Card.create!(
  description: "Zara\nMusic Placement\nANR \"Stay Kids\"\n2014",
  link: "http://youtu.be/MX1Fpor2VAI",
  background: File.open(Rails.root.join("db", "seeds", "images", "home-pic2.png"))
)

Card.create!(
  description: "Mondrian Hotel\nMusic Placement\nPlains \"Little Haiti\"\n2014",
  link: "https://www.youtube.com/watch?v=pIi7rcOWgdE&feature=youtu.be",
  background: File.open(Rails.root.join("db", "seeds", "images", "home-pic3.png"))
)

Card.create!(
  description: "Icona Pop\n\"Light Me Up\"\nSongwriter/Producer\n2014",
  link: "https://www.youtube.com/watch?v=DnoNGqYGOXs",
  background: File.open(Rails.root.join("db", "seeds", "images", "home-pic6.png"))
)

Card.create!(
  description: "NICKY BLITZ\n\"Alex\"\nSingle + Video\n2014",
  link: "https://www.youtube.com/watch?v=-HIrrUJX2AY",
  background: File.open(Rails.root.join("db", "seeds", "images", "home-pic4.png"))
)
...
Card.create!(
  ...
  background: File.open(Rails.root.join("db", "seeds", "images", "home-pic5.png"))
)
